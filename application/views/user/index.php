      ...
      <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar">
          <ul>
            ...
            <li><a class="nav-link scrollto" href="<?= base_url('dashboard/diamonds'); ?>">Topup</a></li>
    ...
    <main id="main">
      ...
      <section id="topup" class="topup">
        <div class="container" data-aos="fade-up">
          ...
          <div class="row">
            <div class="col-xl-3 col-md-3 d-flex align-items-center justify-content-center" data-aos="zoom-in" data-aos-delay="100">
            ...
            <div class="col-xl-3 col-md-3 d-flex align-items-center justify-content-center mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            ...
            <div class="col-xl-3 col-md-3 d-flex align-items-center justify-content-center mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="300">
        ...
        <div class="container" data-aos="zoom-in">
          <div class="row">
            ...
            <div class="col-lg-9 text-center text-lg-start">
              <h3>About Us</h3>
              <p>
                Gportal adalah portal game online terpercaya dan terbaik di Indonesia. Kami menyediakan layanan Top up game seperti Diamond, UC, dll. Untuk mempermudah pembayaran anda dapat melakukan
                pembayaran melalui Dompet Digital dan Bank. Selain itu anda juga dapat melihat berita serta update seputar Gportal maupun game yang sedang populer dan terbaru.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="news" class="news">
        <div class="container" data-aos="fade-up">
          ...
          <div class="row">
            <div class="col-xl-4 col-md-8 d-flex align-items-center justify-content-center" data-aos="zoom-in" data-aos-delay="100">
              <a href="<?= base_url('user'); ?>/promo" class="details-link" title="Top up">
                <img src="<?= base_url('components'); ?>/img/news/news-1.png" class="img-fluid" alt="" />
              </a>
            </div>

            <div class="col-xl-4 col-md-8 d-flex align-items-center justify-content-center mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
              <a href="<?= base_url('user'); ?>/sosmed" class="details-link" title="Top up">
                <img src="<?= base_url('components'); ?>/img/news/news-2.png" class="img-fluid" alt="" />
              </a>
            </div>

            <div class="col-xl-4 col-md-8 d-flex align-items-center justify-content-center mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="300">
